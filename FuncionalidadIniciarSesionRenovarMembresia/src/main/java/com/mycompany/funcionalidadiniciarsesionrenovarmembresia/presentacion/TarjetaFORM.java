 ...
 * @author Jaime
 */
public class TarjetaFORM extends JDialog {
    private ControlForms control;
    /**
     * Creates new form TarjetaFORM
     */
    public TarjetaFORM(Frame parent, boolean modal, ControlForms control) {
        super(parent, modal);
    ...
    private void btnPagarAhoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPagarAhoraActionPerformed
        if (txtNombreTitular.getText().trim().isEmpty() || txtNumeroTarjeta.getText().trim().isEmpty() || txtCVV.getText().trim().isEmpty() || txtFechaVencimiento.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Ups, algo salió mal con el pago, inténtalo de nuevo.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        JOptionPane.showMessageDialog(this, "¡Pago exitoso! Membresía renovada.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        dispose();
