 ...
 * @author Luis
 */
public class IniciarSesionFORM extends JDialog {

    private static final Logger LOGGER = System.getLogger(IniciarSesionFORM.class.getName());
     ...
     */
    public IniciarSesionFORM(Frame parent, boolean modal, ControlForms control) {
        super(parent, modal);
