...
public class BeneficiosFORM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel.add(btnPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 390, 187, 54));

        jSeparator1.setBackground(new java.awt.Color(225, 6, 0));
        jSeparator1.setForeground(new java.awt.Color(225, 6, 0));
        jPanel.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 93, 960, 10));

        jSeparator3.setBackground(new java.awt.Color(225, 6, 0));
        jSeparator3.setForeground(new java.awt.Color(225, 6, 0));
        jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, -1, 140));
        ...
        jPanel.add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 9, 360, 94));
        ...
        jPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 370, 140));

        checkBoxMusica.addActionListener(this::checkBoxMusicaActionPerformed);
        jPanel.add(checkBoxMusica, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 100, 20, 30));
        ...
        jPanel.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, 280, 140));

        jSeparator5.setBackground(new java.awt.Color(225, 6, 0));
        jSeparator5.setForeground(new java.awt.Color(225, 6, 0));
        jPanel.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 950, -1));
        ...
        jPanel.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 251, 370, -1));

        jSeparator6.setBackground(new java.awt.Color(225, 6, 0));
        jSeparator6.setForeground(new java.awt.Color(225, 6, 0));
        jSeparator6.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(373, 5, 10, 530));

        checkBoxInstalaciones.addActionListener(this::checkBoxInstalacionesActionPerformed);
        jPanel.add(checkBoxInstalaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 20, 20));
        ...
        jPanel.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 370, 130));

        checkBoxNutricion.addActionListener(this::checkBoxNutricionActionPerformed);
        jPanel.add(checkBoxNutricion, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 110, 20, -1));
        ...
        jPanel.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 290, 140));
        ...
        jPanel.add(lblPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 340, 210, 40));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 544, Short.MAX_VALUE)))
        );
